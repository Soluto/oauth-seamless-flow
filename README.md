...
## Why a new protocol?
Authentication is an essential part of all the apps, but it also has challenges.
...
But user interaction is not always an option, as it affect the user experience.
App developers need to choose between security and useability, not a simple choice.
This protocol allows them to add strong authentication solution, without affecting the user experience.
...
The current version is published as github pages [here](https://soluto.github.io/oauth-seamless-flow/draft-seamless-flow.html)
...
This flow allows the app to authenticate without any user interaction at all.
